...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nO menor valor entre dois valores e: " + 
		...
		"Texto minusculo: " + Texto.letrasMinusculas("Aula de JAVA DB1 Start 2019"));
		System.out.println("\nTamanho do nome: " + Texto.quantidadeDeCaracteres("Aula de JAVA DB1 Start 2019"));
	}
}
